...
Репозиторий создан, как форк [репозитория](https://github.com/Daabramov/Sonarqube-for-1c-docker). 
...
Так как сделано сразу много исправлений и дополнений, то решено было сделать именно форк [репозитория](https://github.com/Daabramov/Sonarqube-for-1c-docker), а не пытаться дополнять существующий репозиторий при помощи пулл-реквестов.

На бинарном уровне собираемые в данном репозитории образы совместимы и взаимозаменяемы с образами [репозитория](https://github.com/Daabramov/Sonarqube-for-1c-docker). 

## Базовые репозитории, использованные при в этом репозитории
