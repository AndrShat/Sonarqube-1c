...
Репозиторий является идейным продолжением [репозитория](https://github.com/Daabramov/Sonarqube-for-1c-docker), но с существенными различиями, которые потребовали вынесения их в отдельный репозиторий. 
Различия:
...
## Базовые репозитории образов, используемые в коде
